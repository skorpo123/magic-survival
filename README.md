# Magic Survival: Echoes of Arcana

roguelite survival game inspired by Magic Survival, built in Godot 4.6.2 (GDScript).

## Gameplay

Survive endless waves of enemies by collecting XP, leveling up, and choosing new spells and upgrades. Combine spells with modifications to create powerful fusion spells. Fight bosses every 5 minutes in dedicated arenas.
...
Download the latest build for Windows from [Releases](https://github.com/skorpo123/magic-survival/releases).
